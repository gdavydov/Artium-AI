...
- `scripts/install-dependencies.sh` — installs every CLI needed to build/deploy this repo on a fresh Linux machine (see `docs/INSTALL.md`)
...
Supabase CLIs. See `docs/INSTALL.md` for what each one is for and what to
do next.
